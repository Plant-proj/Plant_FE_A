  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          'relative w-8 h-8 p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md group/day aspect-square select-none m-auto',
